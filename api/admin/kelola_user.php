...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_id'])) {
    ...
    header("Location: /api/admin/kelola_user.php"); exit();
}
...
<body>
  <nav class="clay-nav sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-3.5 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <a href="/api/admin/dashboard.php" class="w-9 h-9 bg-gray-100 hover:bg-gray-200 rounded-xl flex items-center justify-center transition text-base" title="Kembali">←</a>
        <div>
  ...
  <form id="form-hapus" method="POST" action="/api/admin/kelola_user.php" style="display:none;">

...
<body>
  ...
  <main class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
      <a href="/api/admin/kelola_user.php" class="menu-card group">
      ...
      <a href="/api/admin/kelola_admin.php" class="menu-card group">
      ...
      <a href="/api/admin/kelola_survei.php" class="menu-card group">

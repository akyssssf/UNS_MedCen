...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['tambah_admin'])) {
    ...
    header("Location: /api/admin/kelola_admin.php"); exit();
}
...
<body>
  <nav class="clay-nav sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-3.5 flex items-center gap-3">
      <a href="/api/admin/dashboard.php" class="w-9 h-9 bg-gray-100 hover:bg-gray-200 rounded-xl flex items-center justify-center transition text-base">←</a>
      <div>
  ...
  <main class="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1">
      <div class="admin-card">
        ...
        <form action="/api/admin/kelola_admin.php" method="POST" class="space-y-3">
          <div>
  ...
  <form id="form-hapus" method="POST" action="/api/admin/kelola_admin.php" style="display:none;">
